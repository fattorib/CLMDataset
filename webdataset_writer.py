...
def parse():
    ...
    parser.add_argument("--num-ctx", default=512, type=int)

    parser.add_argument("--num-train-chunks", default=10, type=int)

    parser.add_argument("--num-validation-chunks", default=10, type=int)
